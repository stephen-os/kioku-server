...
class TagControllerTests {
    ...
    private static final Logger logger = LoggerFactory.getLogger(TagControllerTests.class);
    ...
    void setUp() {
        ...
        when(testTag.getName()).thenReturn(TEST_NAME);

        testTag2 = mock(Tag.class);
        when(testTag2.getId()).thenReturn(2L);
        when(testTag2.getName()).thenReturn("adjectives");
    ...
    void testGetDeckTagsSuccess() {
        ...
        List<Tag> tags = Arrays.asList(testTag, testTag2);
    ...
    void testUpdateTagSuccess() {
        ...
        Tag updatedTag = mock(Tag.class);
        when(updatedTag.getId()).thenReturn(TEST_TAG_ID);
        when(updatedTag.getName()).thenReturn(UPDATED_NAME);
