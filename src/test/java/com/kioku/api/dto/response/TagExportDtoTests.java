...
class TagExportDtoTests {

    private static final Logger logger = LoggerFactory.getLogger(TagExportDtoTests.class);
    ...
    void testEntityConstructor() {
        ...
        when(mockTag.getName()).thenReturn(TAG_NAME);

        TagExportDto dto = new TagExportDto(mockTag);
    ...
    void testEntityConstructorWithNullId() {
        ...
        Tag mockTag = mock(Tag.class);
        when(mockTag.getId()).thenReturn(null);
        when(mockTag.getName()).thenReturn(TAG_NAME);
    ...
    void testEntityConstructorWithUnicode() {
        ...
        Tag mockTag = mock(Tag.class);
        when(mockTag.getId()).thenReturn(TAG_ID);
        when(mockTag.getName()).thenReturn("動詞");
